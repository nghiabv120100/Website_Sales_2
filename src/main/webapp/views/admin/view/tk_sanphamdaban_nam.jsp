                ...
                <div class="col-md-12">
                    <div>
                        <form style="margin-left: 25px; margin-bottom: 25px; margin-top: 50px" action="TK_SanPhamDaBanController" method="get" enctype='multipart/form-data'>
                            ...
                            <label style="size: 20px" >Năm : </label>   &emsp;  <input name="nam" id="nam" type="number" min="2015" value="${tk_year}" style="display: inline"/>
...
<%--                        <form style="margin-left: 90px; margin-bottom: 50px; margin-top: 25px" action="TK_SanPhamDaBanController" method="post" enctype='multipart/form-data'>
